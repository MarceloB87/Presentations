...
---
# Projetos e análises em andamento

+ Modelagem do efeito de estratégia de vacinação de acordo com mudança no intervalo entre doses, critério para mudança de faixa etária de grupos vacinais e aumento na produção de vacinas.

--

+ Disponibilização de séries temporais de cobertura vacinal em diferentes Estados por tipo de dose, tipo de vacina e faixa etária.

--

+ Análise contrafactual: estimativa do número de óbitos esperados na ausência de vacinação em diferentes faixas etárias (parceria com o _PROCC - Fiocruz_)

---
# Lições

União faz a força: trabalho __interdisciplinar__ e __colaborativo__ <!-- ninguém isolado faria uma fração do que estamos fazendo, e todo colaborador, independente da fase da carreira, conta -->
